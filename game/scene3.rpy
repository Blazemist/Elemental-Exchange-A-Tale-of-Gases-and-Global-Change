label scene3:
    ...
    # hide grandpa glad
    # show grandpa 6_packs ar right
    gp "I’m as fine and dandy as can be."
    # hide grandpa 6_packs
    # show local destoryer_of_the_world_i_mean_shamen at right
    ...
    # hide local destoryer_of_the_world_i_mean_shamen
    # show grandma releifed at right
